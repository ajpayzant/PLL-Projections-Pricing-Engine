...
st.info(
    ...
    "Click **🔄 Update Projection** in the sidebar to apply all changes immediately. "
...
# Render after depth-chart controls so same-click updates capture active/usage/starter changes.
render_global_projection_runner(engine=engine, key_prefix="depth")
