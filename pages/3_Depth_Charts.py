...
if current_rosters:
    st.markdown(
        ...
        f'Players not matched to the current roster are excluded from the projection pool before manual toggles.</span>',
        unsafe_allow_html=True,
    )
else:
    st.markdown(
        '<span class="note-text">Official roster filter unavailable; using latest-team stat-log fallback.</span>',
        unsafe_allow_html=True,
    )
